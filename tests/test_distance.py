...
class TestCaseDistanceBase:
    def test_XYZ(self):
        self._test(XYZ(), [0.12412, 0.07493, 0.3093], [0.12412, 0.07493, 0.3093], 0.0)
    ...
    def test_CAM16LCD_distance(self):
        ...
        cs = CAM16LCD(illuminant_xyz=D65 * 100.0, L_A=60.0, Y_b=20.0, surround=Average)
        self._test(cs, [0.12412, 0.07493, 0.3093], [0.12412, 0.07493, 0.3093], 0.0)
...
class TestCaseDistance3D(TestCaseDistanceBase, unittest.TestCase):
    def _test(
        ...
        np.testing.assert_almost_equal(res_2d, [[ref, ref], [ref, ref]], decimal=6)
